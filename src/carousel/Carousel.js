...
export default class Carousel extends Component {
    ...
    static propTypes = {
        ...
        inactiveSlideLastIndexOpacity: PropTypes.number,
        inactiveSlideLastIndexScale: PropTypes.number,
    ...
    static defaultProps = {
        ...
        inactiveSlideLastIndexOpacity: 0.7,
        inactiveSlideScale: 0.9,
        inactiveSlideLastIndexScale: 0.9,
